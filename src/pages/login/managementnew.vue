                        ...
                        <div class="con_item_l">
                            ...
                            <div class="item_bottom">
                                <div class="bottom_con">
                                    <p>{{$t("userHead.item_nav5")}}：<span>{{item.dev_type}}</span></p>
                                    <p>SN:{{item.dev_sn}}</p>
                                </div>
                                <div class="bottom_con">
                                    <p>IP:{{item.dev_ip}}</p>
                                    <p>MAC:{{item.dev_mac}}</p>
                                </div>
                            </div>
                            ...
                            if (res.data.bind_devinfo_list.length > 0) {
                                ...
                                for (let j = 0; j < this.localcache.length; j++) {
                                    if (this.localcache[j].dev_online_state == 0) {
                                        //this.localcache[j].equipment = $t("userActive.item_nav2")
                                       ...
                                       // this.localcache[j].equipment = $t("userActive.item_nav1")
